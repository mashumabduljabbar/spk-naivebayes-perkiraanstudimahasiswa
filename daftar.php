...
<section id="daftar">
		...
		if (isset($_GET['berhasil'])){
			...
			switch ($berhasil){
				...
				echo "<strong>GAGAL INPUT!</strong> User ID atau Password mungkin sudah pernah dipakai \"TES KELULUSAN\".";
				echo "</div>";
				break;
				...
				echo "<a href=\"#\" class=\"close\" data-dismiss=\"alert\" aria-label=\"close\">&times;</a>";
				echo "<strong>BERHASIL!</strong> Selamat anda sudah terdaftar menjadi member \"TES KELULUSAN\".";
				echo "</div>";
				break;
      ...
      <div class="row">
        ...
        <div class="col-lg-12 wow fadeInLeft delay-06s">
          <form class="form" method="POST" action="signup.php">
			<h3>Nama Lengkap</h3>
            <input class="input-text" type="text" name="nama_lengkap" placeholder="Nama Lengkap">
            <h3>Tanggal Lahir</h3>
			...
			<h3>Nama Perguruan Tinggi</h3>
            <input class="input-text" type="text" name="nama_perti" placeholder="Nama Perguruan Tinggi">
            <h3>Nama Program Studi</h3>
            <input class="input-text" type="text" name="nama_jurusan" placeholder="Nama Jurusan / Program Studi">
            <h3>Tahun Masuk</h3>
            <input class="input-text" type="text" name="tahun_masuk" placeholder="Tahun Masuk Kuliah">
